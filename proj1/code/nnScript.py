...
train_acc = str(np.mean((predicted_label == train_label).astype(float)) * 100)
...
# pickle.dump(obj, open('params.pickle'%(train_acc,validation_acc,test_set_acc,str(lambdaval),str(n_hidden)),'wb'))
